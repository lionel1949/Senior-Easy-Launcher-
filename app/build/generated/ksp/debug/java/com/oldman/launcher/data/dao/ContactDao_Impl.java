  ...
  public ContactDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfContactEntity = new EntityInsertionAdapter<ContactEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `contacts` (`id`,`name`,`wechat_id`,`avatar_path`,`phone_number`) VALUES (nullif(?, 0),?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(3, entity.getWechatId());
        statement.bindString(4, entity.getAvatarPath());
    ...
    this.__updateAdapterOfContactEntity = new EntityDeletionOrUpdateAdapter<ContactEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `contacts` SET `id` = ?,`name` = ?,`wechat_id` = ?,`avatar_path` = ?,`phone_number` = ? WHERE `id` = ?";
      }
    ...
    return CoroutinesRoom.createFlow(__db, false, new String[] {"contacts"}, new Callable<List<ContactEntity>>() {
      ...
      public List<ContactEntity> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfWechatId = CursorUtil.getColumnIndexOrThrow(_cursor, "wechat_id");
          ...
          while (_cursor.moveToNext()) {
            ...
            final String _tmpWechatId;
            _tmpWechatId = _cursor.getString(_cursorIndexOfWechatId);
            final String _tmpAvatarPath;
            _tmpAvatarPath = _cursor.getString(_cursorIndexOfAvatarPath);
            final String _tmpPhoneNumber;
            _tmpPhoneNumber = _cursor.getString(_cursorIndexOfPhoneNumber);
            _item = new ContactEntity(_tmpId,_tmpName,_tmpWechatId,_tmpAvatarPath,_tmpPhoneNumber);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public ContactEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final String _tmpPhoneNumber;
            _tmpPhoneNumber = _cursor.getString(_cursorIndexOfPhoneNumber);
            _result = new ContactEntity(_tmpId,_tmpName,_tmpWechatId,_tmpAvatarPath,_tmpPhoneNumber);
          } else {
            _result = null;
          }
          return _result;
